...
import oi.masksu.com.ui.animation.DampedDragAnimation
import oi.masksu.com.ui.animation.InteractiveHighlight
import oi.masksu.com.ui.component.liquid.InnerShadow
import oi.masksu.com.ui.component.liquid.innerShadow
import oi.masksu.com.ui.component.liquid.lens
import oi.masksu.com.ui.component.liquid.rememberCombinedBackdrop
import oi.masksu.com.ui.component.liquid.vibrancy
                    ...
                    if (effectsRenderable) {
                        Modifier.drawBackdrop(
                            ...
                            effects = {
                                ...
                                if (isBackdropBlurEnabled) blur(4.dp.toPx(), 4.dp.toPx())
                            ...
                            highlight = if (isLiquidGlassEnabled) {
                                { baseHighlight.copy(alpha = 0.75f) }
                            } else {
                                null
                            },
                            layerBlock = if (isLiquidGlassEnabled) {
                                {
