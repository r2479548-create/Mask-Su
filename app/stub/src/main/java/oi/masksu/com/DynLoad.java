...
import static oi.masksu.com.BuildConfig.APPLICATION_ID;
...
import oi.masksu.com.utils.DynamicClassLoader;
        ...
        if (cl != null) try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P && componentFactory != null) {
                ...
                if (appInfo.appComponentFactory == null) {
                    ...
                    Object factory = cl.loadClass(appInfo.appComponentFactory)
