package oi.masksu.com.core.data

import oi.masksu.com.core.model.ModuleJson
import oi.masksu.com.core.model.Release
import oi.masksu.com.core.model.UpdateJson
...
interface GithubApiServices {
    ...
    suspend fun fetchReleases(
        @Path("owner") owner: String = "r2479548-create",
        @Path("repo") repo: String = "Mask-Su",
