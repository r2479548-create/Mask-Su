package oi.masksu.com.core.download
...
import oi.masksu.com.core.ktx.set
import oi.masksu.com.core.utils.ProgressInputStream
...
class DownloadEngine(session: DownloadSession) : DownloadSession by session, DownloadNotifier {
    ...
    companion object {
        const val ACTION = "oi.masksu.com.DOWNLOAD"
