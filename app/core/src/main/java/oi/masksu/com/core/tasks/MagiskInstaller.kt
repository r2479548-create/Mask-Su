...
import oi.masksu.com.core.AppApkPath
...
import oi.masksu.com.core.ktx.copyAll
import oi.masksu.com.core.ktx.writeTo
import oi.masksu.com.core.utils.DataSourceChannel
import oi.masksu.com.core.utils.DummyList
import oi.masksu.com.core.utils.MediaStoreUtils
import oi.masksu.com.core.utils.MediaStoreUtils.inputStream
import oi.masksu.com.core.utils.MediaStoreUtils.openFd
...
abstract class MagiskInstallImpl protected constructor(
    ...
    private suspend fun extractFiles(): Boolean {
        ...
        try {
            // Extract binaries
            if (isRunningAsStub) {
                org.apache.commons.compress.archivers.zip.ZipFile.builder().setFile(StubApk.current(context)).get().use { zf ->
